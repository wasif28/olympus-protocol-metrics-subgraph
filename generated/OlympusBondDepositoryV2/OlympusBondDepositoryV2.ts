...
export class OlympusBondDepositoryV2__adjustmentsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class OlympusBondDepositoryV2__depositResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class OlympusBondDepositoryV2__marketsResult {
  value0: BigInt;
  value1: Address;
  value2: boolean;
  value3: BigInt;
...
export class OlympusBondDepositoryV2__metadataResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OlympusBondDepositoryV2__notesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OlympusBondDepositoryV2__pendingForResult {
  value0: BigInt;
  value1: boolean;
...
export class OlympusBondDepositoryV2__termsResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OlympusBondDepositoryV2 extends ethereum.SmartContract {
  static bind(address: Address): OlympusBondDepositoryV2 {
    return new OlympusBondDepositoryV2("OlympusBondDepositoryV2", address);
  }

  adjustments(param0: BigInt): OlympusBondDepositoryV2__adjustmentsResult {
    ...
    return new OlympusBondDepositoryV2__adjustmentsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_adjustments(
    param0: BigInt
  ): ethereum.CallResult<OlympusBondDepositoryV2__adjustmentsResult> {
    ...
    return ethereum.CallResult.fromValue(
      new OlympusBondDepositoryV2__adjustmentsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean()
  ...
  deposit(
    ...
    _user: Address,
    _referral: Address
  ): OlympusBondDepositoryV2__depositResult {
    let result = super.call(
      "deposit",
    ...
    return new OlympusBondDepositoryV2__depositResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_deposit(
    ...
    _user: Address,
    _referral: Address
  ): ethereum.CallResult<OlympusBondDepositoryV2__depositResult> {
    let result = super.tryCall(
      "deposit",
      "deposit(uint256,uint256,uint256,address,address):(uint256,uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OlympusBondDepositoryV2__depositResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  markets(param0: BigInt): OlympusBondDepositoryV2__marketsResult {
    let result = super.call(
      "markets",
    ...
    return new OlympusBondDepositoryV2__marketsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBoolean(),
      result[3].toBigInt(),
  ...
  try_markets(
    param0: BigInt
  ): ethereum.CallResult<OlympusBondDepositoryV2__marketsResult> {
    let result = super.tryCall(
      "markets",
      "markets(uint256):(uint256,address,bool,uint64,uint64,uint64,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OlympusBondDepositoryV2__marketsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBoolean(),
        value[3].toBigInt(),
  ...
  metadata(param0: BigInt): OlympusBondDepositoryV2__metadataResult {
    let result = super.call(
      "metadata",
    ...
    return new OlympusBondDepositoryV2__metadataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_metadata(
    param0: BigInt
  ): ethereum.CallResult<OlympusBondDepositoryV2__metadataResult> {
    let result = super.tryCall(
      "metadata",
      "metadata(uint256):(uint48,uint48,uint48,uint48,uint48,uint8)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OlympusBondDepositoryV2__metadataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  notes(param0: Address, param1: BigInt): OlympusBondDepositoryV2__notesResult {
    let result = super.call(
      "notes",
    ...
    return new OlympusBondDepositoryV2__notesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_notes(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<OlympusBondDepositoryV2__notesResult> {
    let result = super.tryCall(
      "notes",
      "notes(address,uint256):(uint256,uint48,uint48,uint48,uint48)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OlympusBondDepositoryV2__notesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  pendingFor(
    _user: Address,
    _index: BigInt
  ): OlympusBondDepositoryV2__pendingForResult {
    let result = super.call(
      "pendingFor",
    ...
    return new OlympusBondDepositoryV2__pendingForResult(
      result[0].toBigInt(),
      result[1].toBoolean()
    );
  }
  ...
  try_pendingFor(
    _user: Address,
    _index: BigInt
  ): ethereum.CallResult<OlympusBondDepositoryV2__pendingForResult> {
    let result = super.tryCall(
      "pendingFor",
      "pendingFor(address,uint256):(uint256,bool)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OlympusBondDepositoryV2__pendingForResult(
        value[0].toBigInt(),
        value[1].toBoolean()
      )
    );
  ...
  redeem(_user: Address, _indexes: Array<BigInt>, _sendgOHM: boolean): BigInt {
    let result = super.call(
      "redeem",
      ...
      [
        ...
        ethereum.Value.fromBoolean(_sendgOHM)
      ]
    );
  ...
  redeemAll(_user: Address, _sendgOHM: boolean): BigInt {
  ...
  try_redeemAll(
    ...
    let result = super.tryCall(
      ...
      [ethereum.Value.fromAddress(_user), ethereum.Value.fromBoolean(_sendgOHM)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
    }
  ...
  terms(param0: BigInt): OlympusBondDepositoryV2__termsResult {
    let result = super.call(
      "terms",
    ...
    return new OlympusBondDepositoryV2__termsResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(
    param0: BigInt
  ): ethereum.CallResult<OlympusBondDepositoryV2__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms(uint256):(bool,uint64,uint48,uint48,uint64)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OlympusBondDepositoryV2__termsResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
